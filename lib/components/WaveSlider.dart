...
class WaveSlider extends StatefulWidget {
  double widthWaveSlider;
  double heightWaveSlider;
  Color wavActiveColor;
  Color wavDeactiveColor;
  Color sliderColor;
  Color backgroundColor;
  Color positionTextColor;
  double duration;
  CallbackSelection callbackStart;
  CallbackSelection callbackEnd;
  WaveSlider({
    Key? key,
    ...
    required this.wavActiveColor, // = Colors.deepPurple,
    required this.wavDeactiveColor, // = Colors.blueGrey,
    required this.sliderColor,// = Colors.red.shade900,
    this.backgroundColor = Colors.grey,
    this.positionTextColor = Colors.grey,
  }) : super(key: key);
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Container(height: 4, color: Colors.red.shade900),
              Expanded(child: Container()),
              Container(height: 4, color: Colors.red.shade900),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        ...
        onHorizontalDragEnd: callbackEnd,
        child: Container(
          color: colorBG ?? Colors.red.shade900,
